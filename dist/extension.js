    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let quickPing = vscode_1.commands.registerCommand("resti.quickPing", () => {
            ...
            axios_1.default({
                ...
                utils.addDeco(data.statusText, selection.line, document.lineAt(selection).range.end.character, activeEditor);
            });
            /**
            ...
            fs_1.readFile(rootPath + "/.resti/endpoints.json", (err, data) => {
                if (err) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.addDeco = void 0;
const vscode_1 = __webpack_require__(1);
function addDeco(contentText, line, column, activeEditor) {
    ...
    const range = new vscode_1.Range(new vscode_1.Position(line, column), new vscode_1.Position(line, column));
